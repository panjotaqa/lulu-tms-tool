...
export const TestCaseControllerDocs = {
  create: () =>
    applyDecorators(
  ...
  moveTestCases: () =>
    applyDecorators(
      ApiOperation({
        summary: 'Mover um ou mais casos de teste para outra pasta',
      }),
      ApiResponse({
        status: 200,
  ...
  findByProjectForSelection: () =>
    applyDecorators(
      ApiOperation({
        summary: 'Listar casos de teste de um projeto (otimizado para seleção)',
      }),
      ApiParam({
        name: 'projectId',
        type: String,
